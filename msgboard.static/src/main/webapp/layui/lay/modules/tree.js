...
;layui.define("jquery", function (e) {
    ...
    r.prototype.init = function (e) {
        ...
        layui.each(n, function (a, n) {
            var l = n.children && n.children.length > 0,
                ...
                s = o(["<li " + (n.spread ? 'data-spread="' + n.spread + '"' : "") + ">", function () {
                    return l ? '<i class="layui-icon layui-tree-spread iconfont">' + (n.spread ? t.arrow[1] : t.arrow[0]) + "</i>" : ""
                }(), function () {
        ...
        e.children("a").on("click", function (e) {
            ...
            layui.$('.layui-tree li').removeClass('active');
            layui.$(this).parent().addClass('active');
        })
