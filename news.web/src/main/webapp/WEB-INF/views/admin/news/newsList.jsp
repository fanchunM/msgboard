        ...
        <div class="main-content-inner" style="height:97%">
            ...
            <div id="dataGridTableButtons" class="datagrid-toolbar-style">
                ...
                <span class="datagrid-toolbar-span"><i class="icon-fixed-width"></i>审核状态</span>
               	<select id="newsStatus" style="width:100px" class="easyui-combobox">
                ...
                <a href="javascript:void(0);" class="easyui-linkbutton a-button" onclick="addTextNews();"><i class="icon-fixed-width"></i>添加文本新闻</a>
                <a href="javascript:void(0);" class="easyui-linkbutton a-button" onclick="addPicNews();"><i class="icon-fixed-width"></i>添加图片新闻</a>
                <a href="javascript:void(0);" class="easyui-linkbutton a-button" onclick="addLinkNews();"><i class="icon-fixed-width"></i>添加外链新闻</a>
            </div>
        </div>
    </div>
