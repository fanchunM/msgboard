    ...
    <div class="main-content" style="margin-top:18px;">
        <div class="main-content-inner" style="height:97%">
            ...
            <div id="dataGridTableButtonsCheck" class="datagrid-toolbar-style">
                ...
                <a href="javascript:void(0);" class="easyui-linkbutton a-button" onclick="checkNews(2);"><i class="icon-fixed-width"></i>审核通过</a>
                <a href="javascript:void(0);" class="easyui-linkbutton a-button" onclick="checkNews(1);"><i class="icon-fixed-width"></i>审核不通过</a>
            </div>
        </div>
    </div>
</div>
