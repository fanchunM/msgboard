    ...
    <div class="main-content" style="margin-top:18px;">
        <div class="main-content-inner" style="height:97%">
            ...
            <div id="dataGridTableButtons" class="datagrid-toolbar-style">
                <a href="javascript:void(0);" class="easyui-linkbutton a-button" onclick="addQucikReply();"><i class="icon-fixed-width"></i>添加快速回复</a>
            </div>
        </div>
    </div>
...
<script src="resources/admin/js/sys/quickReply.js"></script>
